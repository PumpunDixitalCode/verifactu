...
return Config::create()
    ->setEngine($engine = CodeGeneratorEngineFactory::create(
        'src/xsd/SistemaFacturacion.wsdl'
    ))
    ->setTypeDestination('src/Type')
    ->setTypeNamespace('jdgOpenCode\verifactu\Type')
    ->setClientDestination('src')
    ->setClientName('AEATClient')
    ->setClientNamespace('jdgOpenCode\verifactu')
    ->setClassMapDestination('src')
    ->setClassMapName('AEATClassmap')
    ->setClassMapNamespace('jdgOpenCode\verifactu')
